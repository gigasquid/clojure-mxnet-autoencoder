(ns clojure-mxnet-autoencoder.viz
...
;;; Source taken from https://github.com/apache/incubator-mxnet/blob/master/contrib/clojure-package/examples/gan/src/gan/viz.clj
